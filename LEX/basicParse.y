...
%token B256YEAR B256MONTH B256DAY B256HOUR B256MINUTE B256SECOND B256TEXT B256FONT B256FONTASCENT B256FONTDESCENT B256TEXTWIDTH
%token B256SAY B256SYSTEM
%token B256VOLUME
%token B256GRAPHWIDTH B256GRAPHHEIGHT B256GETSLICE B256PUTSLICE B256IMGLOAD B256IMGWIDTH B256IMGHEIGHT
...
floatexpr: '(' floatexpr ')' { $$ = $2; }
	...
	| B256MSEC '(' ')' { addExtendedOp(OPX_MSEC); }
	| B256FONTASCENT '(' ')' { addExtendedOp(OPX_FONTASCENT); }
	| B256FONTASCENT { addExtendedOp(OPX_FONTASCENT); }
	| B256FONTDESCENT '(' ')' { addExtendedOp(OPX_FONTDESCENT); }
	| B256FONTDESCENT { addExtendedOp(OPX_FONTDESCENT); }
	...
	| B256IMGHEIGHT '(' stringexpr ')' {addOp(OP_IMGHEIGHT);  }
	| B256IMGWIDTH '(' stringexpr ')' {addOp(OP_IMGWIDTH);  }
